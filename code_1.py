...
class App(tk.Tk):
    def __init__(self, converter):
        ...
        self.date_label = Label(
            self,
            text=f"1 Dollar equals = {self.currency_converter.convert('USD', 'INR', 1)} INR \n Date : {self.currency_converter.data['date']}",
            relief=tk.GROOVE,
            borderwidth=2,
        )
        ...
        # placing
        self.from_currency_dropdown.place(x=50, y=120)
        self.amount_field.place(x=30, y=150)
        self.to_currency_dropdown.place(x=355, y=120)
        ...
        self.convert_button.place(x=240, y=135)
